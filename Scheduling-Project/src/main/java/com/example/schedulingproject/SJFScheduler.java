...
public class SJFScheduler {
     ...
     * if preemptive is true the shortest job is scheduled for a duration = timeSlot, then the processes array is
     * checked again. if preemptive is false the shortest job is scheduled for a duration = the burst time of that
     * process
     *
     * @param processes a list of processes to be scheduled
     * @param preemptive determines if the scheduling is preemptive or not i.e. if the process is interrupted after
